...
class FunctionalTest(SeleniumTestCase, BusinessMixin):
    ...
    def test_05(self):
        ...
        education_group_years_factory = functools.partial(EducationGroupYearFactory, academic_year=academic_year)

        acronyms = ['PHYS11BA', 'ECON2M1', 'PHYS1BA', 'PHYS2M1', 'PHYS2MA']
        egys = {
            acronym: education_group_years_factory(acronym=acronym)
            for acronym in acronyms
        }
