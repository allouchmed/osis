...
def get_from_education_group_year_and_type(egy, education_group_type):
    try:
        return OfferYearEntity.objects.get(education_group_year=egy, type=education_group_type)
